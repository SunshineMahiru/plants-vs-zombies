            ...
            if ((int)((stopTime.getTime() - startTime.getTime()) * 0.001) >= 20) {
                if (num >= 0 && num <= 5) {
                    if ((int)((stop.getTime() - start.getTime()) * 0.001) >= ((int)(Math.random() * 5) + 20)) {
                        qizhi.add(new QiZhi(qizhis, ROW_CENTER_Y[(int)(Math.random() * 5)], 0.6, 10, 100));
                        start = new Date();
                    }
                    ...
                    if ((int)((stop.getTime() - start.getTime()) * 0.001) >= ((int)(Math.random() * 5) + 15)) {
                        ...
                        if (x < 5) {
                            qizhi.add(new QiZhi(qizhis, ROW_CENTER_Y[(int)(Math.random() * 5)], 1, 20, 100));
                        } else if (x < 11) {
                            tietong.add(new TieTong(tietongs, ROW_CENTER_Y[(int)(Math.random() * 5)], 0.8, 15, 200));
                        } else if (x < 14) {
                            baozhi.add(new BaoZhi(baozhis, ROW_CENTER_Y[(int)(Math.random() * 5)], 0.8, 15, 200));
                        } else {
                            ganlan.add(new GanLan(ganlans, ROW_CENTER_Y[(int)(Math.random() * 5)], 0.8, 15, 200));
                        }
                        start = new Date();
                    }
